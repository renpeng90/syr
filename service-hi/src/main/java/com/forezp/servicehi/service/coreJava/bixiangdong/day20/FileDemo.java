...
class FileDemo
{
	...
	{
		File f1 = new File(UtilGlobalConfig.URL_LOACL_PREFIX_ONE+ "demo_copy.txt");
		File f2 = new File(UtilGlobalConfig.URL_LOACL_PREFIX_ONE+ "hahah.txt");
	...
	{
		File f = new File(UtilGlobalConfig.URL_LOACL_PREFIX_ONE+"\\java1223\\day20\\file2.txt");
